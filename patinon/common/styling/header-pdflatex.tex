...
% Copy these into definitions.tex, which is used for markdown processing / MathJAX.
\newcommand{\ts}{\text{.}}
\newcommand{\tc}{\text{,}}
\newcommand{\tsc}{\text{;}}
\newcommand{\mat}[1]{\mathbf{#1}}

% This appears unnecessary with Gentium (Book) Plus.
% \usepackage{newunicodechar}
% \newfontface\fallbacksymbol{DejaVu Sans}
