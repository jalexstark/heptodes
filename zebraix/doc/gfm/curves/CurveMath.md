...
- [<span class="toc-section-number">1</span> Task](#task)
  - [<span class="toc-section-number">1.1</span> Traditional power
    forms](#traditional-power-forms)
  - [<span class="toc-section-number">1.2</span> Power and weighted
    forms](#power-and-weighted-forms)
    - [<span class="toc-section-number">1.2.1</span> Homogeneous form,
      cubic](#homogeneous-form-cubic)
    - [<span class="toc-section-number">1.2.2</span> Homogeneous form,
      rat-quad](#homogeneous-form-rat-quad)
- [<span class="toc-section-number">2</span> Bilinear](#bilinear)
- [<span class="toc-section-number">3</span> Conversions](#conversions)
  - [<span class="toc-section-number">3.1</span> Power](#power)
  - [<span class="toc-section-number">3.2</span> Weighted](#weighted)
- [<span class="toc-section-number">4</span> Conversion](#conversion)
  - [<span class="toc-section-number">4.1</span> Convert weighted to
    power](#convert-weighted-to-power)
  - [<span class="toc-section-number">4.2</span> Convert power to
    weighted](#convert-power-to-weighted)
- [<span class="toc-section-number">5</span> Range
  manipulation](#range-manipulation)
  - [<span class="toc-section-number">5.1</span> Range cut](#range-cut)
  - [<span class="toc-section-number">5.2</span> Range
    reassignment](#range-reassignment)
- [<span class="toc-section-number">6</span> Derivatives](#derivatives)
  - [<span class="toc-section-number">6.1</span> Cubic](#cubic)
  - [<span class="toc-section-number">6.2</span> RQ](#rq)
  - [<span class="toc-section-number">6.3</span> Cubic
    end-points](#cubic-end-points)
  - [<span class="toc-section-number">6.4</span> RQ
...
negative. This will always be the case for a valid range cut. What makes
a range cut invalid?
...
$t= \phi(v, w, \sigma)$, where

$$
\phi(v, w, \sigma) = \frac{w-\sigma v}{1-\sigma}
$$

Recall that both $w-v$ and $\sigma$ must be positive. When $\sigma < 1$
all terms are positive in
...
Denominator is square of the non-differentiated denominator. In essence
this is the same for power and weighted.
